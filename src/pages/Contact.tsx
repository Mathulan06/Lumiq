...
const Contact = () => {
  ...
  const inputClass =
    "w-full font-body text-sm border-0 border-b border-neutral-200 bg-transparent py-3 text-foreground placeholder:text-neutral-400 focus:outline-none focus:border-neutral-900 transition-colors duration-200";
